package com.yunxian.draggablelinearlistview.lib;
...
import com.yunxian.draggablelinearlistview.lib.adapter.DraggableBaseAdapter;
import com.yunxian.draggablelinearlistview.lib.adapter.LinearBaseAdapter;
...
import com.yunxian.draggablelinearlistview.lib.extend.ViewWithIndex;
...
import com.yunxian.draggablelinearlistview.lib.util.DensityUtil;
import com.yunxian.draggablelinearlistview.lib.util.Utils;
...
public class DraggableLinearListView extends LinearListView{
	...
	private void initAttr( Context context, AttributeSet attrs ){
		...
		int index = a.getInt(LinearLayout_orientation, VERTICAL);
		if( index >= 0 ){
			setOrientation(index==1?VERTICAL:HORIZONTAL);
		}
		a.recycle();
	...
	/**
	 *	设置拖拽响应类型
	 * @param mDragTriggerType	{@see #com.yunxian.draggablelinearlistview.lib.extend.DragTriggerType}
	 */
